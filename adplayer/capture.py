...
def _warn_if_template_fills_frame(gray_small, markers):
    ...
    карта откликов 1x1, никакой устойчивости к сдвигу кадрирования. Сейчас так
    и есть (маркеры — полноэкранные 1920x1080), работает — но об ограничении
    лучше знать из лога, а не выяснять заново при следующей поломке.
    """
